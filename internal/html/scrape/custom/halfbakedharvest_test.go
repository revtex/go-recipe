...
func TestNewHalfBakedHarvestScraper(t *testing.T) {
	...
	scraperTest := test.Scraper{
		...
		Instructions: []string{
			"To make the rice. Melt the butter with the rice, orzo, and pine nuts in a medium pot over medium heat. Let the butter brown. Add 2 cups water or broth (or bone broth). Bring to a boil over high heat. Reduce the heat to low, cover, and simmer for 10 minutes. Turn the heat off. Allow the rice to cook, covered, for 15-20 minutes more. Fluff the rice with a fork.",
			"To make the chicken. Mix the chicken, butter, lemon juice, garlic, smoked paprika, oregano, rosemary, salt, pepper, and chili flakes in a bowl. If time allows, let it sit for 10 minutes or up to overnight to deepen the flavor.",
			"Set your grill, grill pan, or skillet to medium-high heat. Thread the chicken onto skewers. Grill the skewers until lightly charred and cooked through, turning them occasionally throughout cooking, about 10 to 12 minutes total. During the same time, grill the peppers and zucchini for 3-4 minutes per side.",
			"Serve the chicken with Tzatziki sauce and crumbled feta over bowls of rice pilaf. Arrange the gilled veggies and tomatoes on the side. Top with herbs. I like to add naan or pita bread too!",
		},
